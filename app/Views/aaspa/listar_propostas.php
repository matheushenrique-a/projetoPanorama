							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">AASPA - Listar propostas</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div id="kt_app_content_container" class="app-container container-xxl">
									...
									<div class="card" style="justify-content: start;">
										<!--begin::Card header-->
										<!--begin::Form-->
										<form id="frmDataLake" class="form" action="<?php echo assetfolder;?>aaspa-listar-propostas" method="POST">
											<div class="card-header border-0 pt-6" style="justify-content: start;">
												...
												<div class="card-title">
													...
													<div class="d-flex align-items-center position-relative my-1 mx-3">
														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label text-gray-800 mb-0">integraallId:</label>
															<input type="text" class="form-control" placeholder="" name="integraallId" value="<?php echo $integraallId;?>" />
														</div>													
													</div>
													<div class="d-flex align-items-center position-relative my-1 mx-3">
														<div class="mb-3">
													...
													<div class="d-flex align-items-center position-relative my-1 mx-3">
														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label text-gray-800 mb-0">emailPessoal:</label>
															<input type="text" class="form-control" placeholder="" name="emailPessoal" value="<?php echo $emailPessoal;?>" />
														</div>													
													</div>
												</div>
												<!--begin::Card title-->
												...
												<tbody class="text-gray-600 fw-semibold">
													...
													?>
														<tr>
															...
															<!--begin::TELEFONE=-->
															<td>
																	<?php echo formatarTelefone($row->telefonepessoal);?> 
															</td>
															<!--begin::DATA CRIACAO=-->
