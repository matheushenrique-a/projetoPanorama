						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div class="row g-5 g-xl-8">
										<div class="col-xl-6">
											<form id="frmDataLake" class="form" action="<?php echo assetfolder;?>aaspa-receptivo" method="POST">
												<!-- Inicio: detalhes -->
																...
																<div id="kt_accordion_1_body_133" class="accordion-collapse collapse show" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1">
																	<div class="accordion-body">
																		...
																		<div class="d-flex align-items-center position-relative my-1 mt-5 mb-0">
																			<button type="button" class="btn btn-primary" name="btnConsultar" value="btnConsultar" onclick="checkCpf();" >Consultar</button>										
																		</div>

																		<div class="mt-10 mb-3">
																			<div>
																				<span style="color: #bec4bd" id='lblAaspaTop'>
																				...
																				<span class="fs-4">AASPA:</span> <span class="fs-4" id='lblAaspa'></span><span class="fs-4">&nbsp;&nbsp;<i class="fa-solid fa-arrows-rotate fs-3" id='lblAaspaUpdate' style="color: #b3b1b1; cursor: pointer; display: inline;" onclick="checkAaspa();"></i></span>
																			</div>
																			<div class="mt-2">
																				<span style="color: #bec4bd" id='lblINSSTop'>
																					<svg role="img" aria-hidden="true" width="25px" focusable="false" data-prefix="fas" data-icon="circle-check" class="svg-inline--fa fa-circle-check" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM371.8 211.8C382.7 200.9 382.7 183.1 371.8 172.2C360.9 161.3 343.1 161.3 332.2 172.2L224 280.4L179.8 236.2C168.9 225.3 151.1 225.3 140.2 236.2C129.3 247.1 129.3 264.9 140.2 275.8L204.2 339.8C215.1 350.7 232.9 350.7 243.8 339.8L371.8 211.8z"></path></svg>
																				</span>
																				<span class="fs-4">INSS:</span> <span class="fs-4" id='lblINSS'></span><span class="fs-4">&nbsp;&nbsp;<i class="fa-solid fa-arrows-rotate fs-3" id='lblINSSUpdate' style="color: #b3b1b1; cursor: pointer; display: inline;" onclick="checkINSS();"></i></span>
																			</div>
																			<div class="mt-2">
																				<span style="color: #bec4bd" id='lblTSETop'>
																				<svg role="img" aria-hidden="true" width="25px" focusable="false" data-prefix="fas" data-icon="circle-check" class="svg-inline--fa fa-circle-check" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M0 256C0 114.6 114.6 0 256 0C397.4 0 512 114.6 512 256C512 397.4 397.4 512 256 512C114.6 512 0 397.4 0 256zM371.8 211.8C382.7 200.9 382.7 183.1 371.8 172.2C360.9 161.3 343.1 161.3 332.2 172.2L224 280.4L179.8 236.2C168.9 225.3 151.1 225.3 140.2 236.2C129.3 247.1 129.3 264.9 140.2 275.8L204.2 339.8C215.1 350.7 232.9 350.7 243.8 339.8L371.8 211.8z"></path></svg>
																				</span>
																				<span class="fs-4">TSE:</span> <span class="fs-4" id='lblTSE'></span><span class="fs-4">&nbsp;&nbsp;<i class="fa-solid fa-arrows-rotate fs-3" id='lblTSEUpdate' style="color: #b3b1b1; cursor: pointer; display: inline;" onclick="checkTSE();"></i></span>&nbsp;&nbsp;<a href="https://www.tse.jus.br/servicos-eleitorais/autoatendimento-eleitoral#/atendimento-eleitor/consultar-situacao-titulo-eleitor" target="_blank"><i class="fa-solid fa-arrow-up-right-from-square fs-3" id='lblTSESite' style="color: #b3b1b1; cursor: pointer; display: inline;" alt="Abrir Site TSE"></i></a>
																			</div>
																		</div>
																		...
																		<div class="input-group">
																			...
																			<select class="form-control" id="estadoCivil" required="" name="estadoCivil" autocomplete="off" style="width: 35px">
																		...
																		<div class="input-group">
																			...
																			<input type="text" class="form-control" placeholder="" name="email" id="email" style="width: 50px" value="<?php echo $email;?>" />
																		</div>
																		<div class="input-group">
																		...
																		<div class="input-group">
																			...
																			<input type="text" class="form-control" placeholder="" name="cep" id="cep" value="<?php echo $cep;?>"/>
																		</div>
																		<div class="input-group">
																		...
																		<?php }?>
																		<div class="d-flex align-items-center position-relative my-1 mt-5 mb-0">
																			<button type="submit" class="btn btn-primary" name="btnSalvar" value="btnSalvar">Salvar Integraall</button>										
																		</div>
