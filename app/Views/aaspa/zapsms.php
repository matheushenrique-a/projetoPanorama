						...
						<div class="d-flex flex-column flex-column-fluid">
							...
							<div id="kt_app_content" class="app-content flex-column-fluid">
								...
								<div class="row g-5 g-xl-8">
										<div class="col-xl-6">
											<form id="frmDataLake" class="form" action="<?php echo assetfolder;?>aaspa-zapsms" method="POST">
												<!-- Inicio: detalhes -->
															...
															<div class="accordion-item">
																...
																<div id="kt_accordion_1_body_133" class="accordion-collapse collapse show" aria-labelledby="kt_accordion_1_header_1" data-bs-parent="#kt_accordion_1">
																	<div class="accordion-body">
																		...
																		<div class="input-group">
																			<span class="input-group-text bg-color: $ffffff" style="width: 100%"><input class="form-check-input" type="radio" name="tipoMensagem" <?php echo $tipoMensagem == "SMS-AASPA" ? "checked" : ""?> value="SMS-AASPA" />&nbsp;SMS Link AASPA</span>
																		</div>
																		<div class="input-group">
																		...
																		<div class="input-group">
																			<span class="input-group-text" style="width: 155px">Link AASPA</span>
																			<input type="text" class="form-control" placeholder="" name="linkAaspa3" value="<?php echo $linkAaspa3;?>" />
																		</div>
