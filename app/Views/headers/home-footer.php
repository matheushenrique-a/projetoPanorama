				...
				<div class="card-header pe-5" id="kt_drawer_chat_messenger_header">
					...
					<div class="card-title">
						...
						<div class="d-flex justify-content-center flex-column me-3">
							<a href="#" class="fs-4 fw-bold text-gray-900 text-hover-primary me-1 mb-2 lh-1">TELEGRAM</a>
							<!--begin::Info-->
							<div class="mb-0 lh-1">
								<span class="badge badge-success badge-circle w-10px h-10px me-1"></span>
								<span class="fs-7 fw-semibold text-muted">Histórico mensagens</span>
							</div>
							<!--end::Info-->
						</div>
						<!--end::User-->
							...
							<div class="d-flex flex-column align-items-start">
								<div class="d-flex align-items-center mb-2">
									<div class="symbol symbol-30px symbol-circle">
										<img alt="Pic" src="<?php echo assetfolder ?>assets/pravoce/media/logos/pravc_chat.png" />
									</div>
									<div class="ms-3">
										<?php 
										...
										<span class="text-muted fs-7 mb-1"><?php echo $dataEv . " - " . time_elapsed_string($row->last_update);?></span>
									</div>
								</div>
								<div class="p-5 rounded bg-light-info text-dark fw-semibold mw-lg-400px text-start" data-kt-element="message-text"><?php echo translate_telegram($row->categoria) . " " . telegram_message_adjust($row->categoria, $row->mensagem);?></div>
							</div>
						</div>
