...
<head>
	...
	<link rel="shortcut icon" href="<?php echo assetfolder ?>assets/logos/favicon.ico" />
	<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Inter:300,400,500,600,700" />
	<link href="<?php echo assetfolder ?>assets/plugins/custom/fullcalendar/fullcalendar.bundle.css" rel="stylesheet"
		type="text/css" />
	<link href="<?php echo assetfolder ?>assets/plugins/custom/datatables/datatables.bundle.css" rel="stylesheet"
		type="text/css" />
...
<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-sidebar-minimize="on"
	data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true"
				...
				<div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
					...
					<div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
						<a href="<?php echo assetfolder ?>" class="d-lg-none">
							<img alt="Logo" src="<?php echo assetfolder ?>assets/logos/favicon-32x32.png"
								class="h-30px" />
						</a>
					</div>
						...
						<div class="app-header-menu app-header-mobile-drawer align-items-stretch" data-kt-drawer="true"
							...
							<div class="menu menu-rounded menu-column menu-lg-row my-5 my-lg-0 align-items-stretch fw-semibold px-2 px-lg-0"
								...
								<div data-kt-menu-trigger="{default: 'click', lg: 'hover'}"
									...
									<span
										class="menu-link fw-bold text-gray-600 text-hover-gray-800 py-3 px-4 d-flex align-items-center gap-2">
											...
											<div class="row">
												<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
													<div class="row">
															...
															<div class="menu-item p-0 m-0">
																<a href="https://gestao.sistemacorban.com.br/"
																	...
																	<span class="d-flex flex-column">
																		<span
																			class="fs-6 fw-bold text-gray-800">Vanguard</span>
														...
														<div class="col-lg-6 mb-3">
															<div class="menu-item p-0 m-0">
																<a href="https://grupoquid.panoramaemprestimos.com.br/login.do?action=sistema"
																	class="menu-link" target="_blank">
																	<span
																		class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<span class="d-flex flex-column">
																		<span
																			class="fs-6 fw-bold text-gray-800">Panorama</span>
																		<span class="fs-7 fw-semibold text-muted">Acesso
																			sistema</span>
																	</span>
																</a>
														...
														<div class="col-lg-6 mb-3">
															<div class="menu-item p-0 m-0">
																<a href="https://www.bmgconsig.com.br/principal/fsconsignataria.jsp"
																	...
																	<span class="d-flex flex-column">
																		<span class="fs-6 fw-bold text-gray-800">BMG
																			Consig</span>
																		<span class="fs-7 fw-semibold text-muted">Banco
																			BMG</span>
																	</span>
																</a>
															</div>
													...
													<div class="d-flex flex-stack flex-wrap flex-lg-nowrap gap-2 mx-5">
														...
														<a href="<?php echo assetfolder ?>sign-in"
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-300px"
										...
										<div class="menu-item px-1 my-0">
											<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-300px"
												data-kt-menu="true" data-kt-element="theme-mode-menu">
												<div class="menu-item px-1 my-0">
													<h3 class="text-center fs-5 text-gray-800 border-bottom pb-2">
														Notificações</h3>
													<?php if (!empty($notificacoes)): ?>
														<?php foreach ($notificacoes as $notificacao): ?>
															<div class="border-bottom">
																<div
																	class="alert mt-3 alert-warning d-flex justify-content-between align-items-center">
																	<div class="d-flex flex-column gap-3">
																		...
																		<span
																			class="text-gray-900 fs-4"><?= $notificacao['message'] ?: 'Sem mensagem' ?></span>
																	</div>
							...
							<div class="app-navbar-item ms-1 ms-lg-3">
								...
								<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px"
									...
									<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10"
										style="background-image:url('<?php echo assetfolder ?>assets//media/misc/menu-header-bg.jpg')">
										<h3 class="text-white fw-semibold fs-1 mb-3">Central</h3>
									</div>
									<div class="row g-0">
										<?php if ($my_security->checkPermission("ADMIN")): ?>
										...
										<div class="col-6">
											<a href="<?php echo assetfolder ?>clientes"
									...
									<div class="py-2 text-center border-top" style="pointer-events: none;">
										<a href="../../demo1/dist/pages/user-profile/activity.html"
											class="btn btn-color-gray-600 btn-active-color-primary">Ver mais
							...
							<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
								<div class="cursor-pointer symbol symbol-35px symbol-md-40px"
									...
									<?php if (!empty($profile_image)): ?>
										<img src="<?= $profile_image ?>" class="rounded" alt="foto de perfil">
									<?php else: ?>
										<div class="symbol-label fs-2 fw-semibold bg-info text-inverse-info">
											<?php echo substr($session->nickname, 0, 1); ?>
										</div>
									<?php endif; ?>
								</div>
				...
				<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true"
					...
					<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
						<a href="<?php echo assetfolder ?>">
							<img alt="Logo" src="<?php echo assetfolder ?>assets/logos/QUID ONE_nomarge_BRANCO.png"
							...
							<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu"
								...
								<div data-kt-menu-trigger="click" class="menu-item here show menu-accordion">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<a class="menu-link menu-href-link"
												href="<?php echo assetfolder; ?>listar-propostas/0/0">
												<span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
										...
										<div class="menu-item">
											<a class="menu-link menu-href-link"
												href="<?php echo assetfolder; ?>listar-produtos">
												<span class="menu-bullet"><span class="bullet bullet-dot"></span></span>
								...
								<div class="menu-item pt-5">
									<div class="menu-content">
										<span class="menu-heading fw-bold text-uppercase fs-7">FERRAMENTAS</span>
									</div>
								</div>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<a class="menu-link" href="<?php echo assetfolder; ?>bmg-cartao/0"
													...
													<span class="menu-title">Cartão BMG</span>
												</a>
											</div>
											<?php if ($my_security->checkPermission("ADMIN")): ?>
												<div class="menu-item">
								...
								<?php if ($my_security->checkPermission("ADMIN")): ?>
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
												<a class="menu-link" href="<?php echo assetfolder; ?>painel/1">
													<span class="menu-bullet">
														<svg class="w-6 h-6 text-gray-800 dark:text-white"
															aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
															height="24" fill="currentColor" viewBox="0 0 24 24">
								...
								<?php if ($my_security->checkPermission("SUPERVISOR") || $my_security->checkPermission("FORMALIZACAO")): ?>
									<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
										...
										<div class="menu-sub menu-sub-accordion">
											<div class="menu-item">
												<a class="menu-link" href="<?php echo assetfolder; ?>export-propostas/0">
													<span class="menu-bullet">
														<svg class="w-6 h-6 text-gray-800 dark:text-white"
															aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24"
															height="24" fill="currentColor" viewBox="0 0 24 24">
													...
													<span class="menu-title">Extrair propostas</span>
												</a>
											</div>
										</div>
									</div>
										...
										<div class="menu-sub menu-sub-accordion">
											...
											<div class="menu-item">
												<a class="menu-link" href="<?php echo assetfolder; ?>pendencias-edit/0">
													...
													<span class="menu-title">Listar pendências</span>
												</a>
											</div>
										</div>
									</div>
