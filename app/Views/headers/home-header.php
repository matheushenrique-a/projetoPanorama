					...
					<div class="d-flex align-items-stretch justify-content-between flex-lg-grow-1" id="kt_app_header_wrapper">
												...
												<div class="col-lg-8 mb-3 mb-lg-0 py-3 px-3 py-lg-6 px-lg-6">
													...
													<div class="row">
														...
														<div class="col-lg-6 mb-3">
															...
															<div class="menu-item p-0 m-0">
																<!--begin:Menu link-->
																<a href="https://www.bmgconsig.com.br/principal/fsconsignataria.jsp" class="menu-link" target="_blank">
																	<span class="menu-custom-icon d-flex flex-center flex-shrink-0 rounded w-40px h-40px me-3">
																	...
																	<span class="d-flex flex-column">
																		<span class="fs-6 fw-bold text-gray-800">BMG Consig</span>
																		<span class="fs-7 fw-semibold text-muted">Banco BMG</span>
																	</span>
																</a>
																<!--end:Menu link-->
															</div>
						...
						<div class="app-navbar flex-shrink-0">
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column w-250px w-lg-325px" data-kt-menu="true">
								<!--begin::Heading-->
								<div class="d-flex flex-column flex-center bgi-no-repeat rounded-top px-9 py-10" style="background-image:url('<?php echo assetfolder ?>assets//media/misc/menu-header-bg.jpg')">
									<!--begin::Title-->
									<h3 class="text-white fw-semibold mb-3">Central</h3>
									<!--end::Title-->
									<!--begin::Status-->
									<span class="badge bg-primary py-2 px-3">EM BREVE</span>
									<!--end::Status-->
								</div>
								<!--end::Heading-->
								<!--begin:Nav-->
								<div class="row g-0">
									...
									<div class="col-6" style="pointer-events: none;">
										<a href="../../demo1/dist/apps/projects/budget.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end border-bottom">
											...
											<!--end::Svg Icon-->
											<span class="fs-5 fw-semibold text-gray-800 mb-0">Contabilidade</span>
											<span class="fs-7 text-gray-400">Financeiro</span>
										</a>
									</div>
									<!--end:Item-->
									<!--begin:Item-->
									<div class="col-6" style="pointer-events: none;">
										<a href="../../demo1/dist/apps/projects/settings.html" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-bottom">
											...
											<!--end::Svg Icon-->
											<span class="fs-5 fw-semibold text-gray-800 mb-0">Administração</span>
											<span class="fs-7 text-gray-400">Controle</span>
										</a>
									</div>
									<!--end:Item-->
									<!--begin:Item-->
									<div class="col-6">
										<a href="<?php echo assetfolder; ?>insight-listar-propostas/0/0" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light border-end">
											...
											<!--end::Svg Icon-->
											<span class="fs-5 fw-semibold text-gray-800 mb-0">Propostas</span>
											<span class="fs-7 text-gray-400">Contratos</span>
										</a>
									</div>
									<!--end:Item-->
									<!--begin:Item-->
									<div class="col-6" style="<?= $my_security->checkPermission("ADMIN") ? "" : "pointer-events: none"; ?>">
										<a href="<?php echo assetfolder ?>clientes" class="d-flex flex-column flex-center h-100 p-6 bg-hover-light">
											...
											<span class="fs-7 text-gray-400">Movimentações</span>
										</a>
									</div>
									<!--end:Item-->
								</div>
								<!--end:Nav-->
								<!--begin::View more-->
								<div class="py-2 text-center border-top" style="pointer-events: none;">
									<a href="../../demo1/dist/pages/user-profile/activity.html" class="btn btn-color-gray-600 btn-active-color-primary">Ver mais
						...
						<div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
							...
							<div class="cursor-pointer symbol symbol-35px symbol-md-40px" data-kt-menu-trigger="click" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
								<div class="symbol-label fs-2 fw-semibold bg-info text-inverse-info"><?php echo substr($session->nickname, 0, 1); ?></div>
							</div>
							...
							<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
								...
								<!--begin::Menu item-->
								<div class="menu-item px-5">
									<a href="<?php echo assetfolder ?>sign-in" class="menu-link px-5">Sair</a>
								</div>
								<!--end::Menu item-->
							</div>
					...
					<div id="kt_app_sidebar_menu_wrapper" class="app-sidebar-wrapper hover-scroll-overlay-y my-5" data-kt-scroll="true" data-kt-scroll-activate="true" data-kt-scroll-height="auto" data-kt-scroll-dependencies="#kt_app_sidebar_logo, #kt_app_sidebar_footer" data-kt-scroll-wrappers="#kt_app_sidebar_menu" data-kt-scroll-offset="5px" data-kt-scroll-save-state="true">
						...
						<div class="menu menu-column menu-rounded menu-sub-indention px-3" id="#kt_app_sidebar_menu" data-kt-menu="true" data-kt-menu-expand="false">
							...
							<?php if ($my_security->checkPermission("ADMIN")) : ?>
								...
								<!--end:Menu item-->
								<!--begin:Menu item-->
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion" style="<?php $my_security->DisplayMenu("MEGABASE"); ?>">
									<!--begin:Menu link-->
									<span class="menu-link">
										<span class="menu-icon">
									...
									<div class="menu-sub menu-sub-accordion">
										...
										<div class="menu-item">
											<!--begin:Menu link-->
											<a class="menu-link" href="<?php echo assetfolder; ?>index.php/datalake-buscar">
												<span class="menu-bullet">
													<span class="bullet bullet-dot"></span>
												</span>
							...
							<!--end:Menu item-->
							<!--begin:Menu item-->
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion" style="<?php $my_security->DisplayMenu("FGTS"); ?>">
								<!--begin:Menu link-->
								<span class="menu-link">
									<span class="menu-icon">
									...
									<span class="menu-title">FGTS</span>
									<span class="menu-arrow"></span>
								</span>
								<!--end:Menu link-->
								<!--begin:Menu sub-->
							...
							<!--end:Menu item-->
							<!--begin:AMBEC BRASILMenu item-->
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion" style="<?php $my_security->DisplayMenu("AMBEC"); ?>">
								<!--begin:Menu link-->
								<span class="menu-link">
									<span class="menu-icon">
									...
									<span class="menu-title">AMBEC</span>
									<span class="menu-arrow"></span>
								</span>
								<!--end:Menu link-->
								<!--begin:Menu sub-->
								<div class="menu-sub menu-sub-accordion">
									...
									<div class="menu-item">
										<!--begin:Menu link-->
										<a class="menu-link" href="<?php echo assetfolder; ?>ambec-script">
											<span class="menu-bullet">
												<span class="bullet bullet-dot"></span>
											</span>
											<span class="menu-title">Gerar Script IA</span>
										</a>
										<!--end:Menu link-->
									</div>
								</div>
							...
							<?php if ($my_security->checkPermission("BRADESCO")): ?>
								<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
									...
									<span class="menu-link">
										...
										<span class="menu-title">BRADESCO</span>
										<span class="menu-arrow"></span>
									</span>
									<!--end:Menu link-->
									<!--begin:Menu sub-->
							...
							<!--end:CONSORCIO BRASIL Menu item-->
							<!--begin:CONSORCIO BRASILMenu item-->
							<div data-kt-menu-trigger="click" class="menu-item menu-accordion" style="<?php $my_security->DisplayMenu("METRICAS"); ?>">
								<!--begin:Menu link-->
								<span class="menu-link">
									<span class="menu-icon">
										<!--begin::Svg Icon | path: icons/duotune/communication/com013.svg-->
