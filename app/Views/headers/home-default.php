							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Dashboard AASPA</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="card h-xl-100">
												...
												<div class="card-header pt-7 mb-3 pb-3">
													<h3 class="card-title align-items-start flex-column">
														...
														<span class="text-gray-400 mt-1 fw-bold fs-6"><?php echo $countLigacoes;?> <?php echo ($countLigacoes > 1  ? 'ligações atendidas hoje' : 'ligação atendida hoje');?></span>
													</h3>
											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-body pt-6">
													...
													<script>
														...
														const options = {
															series: [{ name: "Averbações", data: [<?php echo $graficoAvebacoes['firstRow']->Averbacoes;?>] }],
															...
															tooltip: { enabled: true, offsetY: 0, style: { fontSize: "12px" } }
															},
															yaxis: {
															labels: { style: { colors: labelColor, fontSize: "12px" } }
															},
