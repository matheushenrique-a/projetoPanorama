							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Padrão</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
												...
												<div class="card">
													...
													<div class="card-header card-header-stretch">
														...
														<div class="card-title d-flex align-items-center">
															...
															<!--end::Svg Icon-->
															<h3 class="fw-bolder m-0 text-gray-800">Minhas notificações</h3>
														</div>
														<!--end::Title-->
														<!--begin::Toolbar-->
																...
																<div class="timeline">
																	...
																	foreach ($notificacoes["result"]->getResult() as $row){
																		...
																		if ($row->tipo == "proposta_criada"){
																			...
																			if ((isset($detalhes['statusFinal'])) and ($detalhes['statusFinal'] == 'APROVADA')) {
																				$icon = "⭐️⭐️🎉 ";
																			}
																		}
																		...
																		if ($tituloInicial != $titulo) {
																			...
																			$i += 1;
																			if ($i > 0 ) {
																				echo '</div></div></div>'; //fecha o bloco anterior que ficou aberto, excerto na primeira interação;
																			}
																	
																	?>

																	<!--begin::NOTIFICAÇÃO BLOCK MASTER-->
																	<div class="timeline-item">
																		
																		<!--begin::NOTIFICACAO ICON-->
																		...
																		<!--end::NOTIFICACAO ICON-->

																		<!--begin::NOTIFICACAO CORPO-->
																		<div class="timeline-content mb-10 mt-n1">
																			<div class="pe-3 mb-5">
																				<div class="fs-5 fw-bold mb-2"><?php echo $titulo;?></div>
																				<div class="d-flex align-items-center mt-1 fs-6">
																					<div class="text-muted me-2 fs-7">Recebida em <?php echo dataUsPtHours($data_criacao, true);?></div>
																				</div>
																			</div>
																		...
																		<?php } ?>
																			...
																			<!--begin::NOTIFICAÇÃO RECORD-->
																			
																				<div class="d-flex align-items-center border border-dashed border-gray-300 rounded min-w-1000px px-7 py-2 mb-2">
																					<a href="" class="fs-5 text-dark text-hover-primary fw-semibold w-275px min-w-275px"><?php echo $icon . $detalhes['integraallId'];?> | <?php echo substr($detalhes['nomeCliente'], 0, 15) ;?>...</a>
																					<div class="min-w-275px pe-2"><span class="badge badge-light text-muted"><?php echo $detalhes['nomeStatus'];?></span></div>
																					<div class="min-w-275px pe-2"><span class="badge badge-light-primary"><?php echo $detalhes['statusAdicional'];?></span></div>
																					<a href="" class="btn btn-sm btn-light btn-active-light-primary">Detalhes</a>
																				</div>
																				
																			
																			<!--end::NOTIFICAÇÃO RECORD-->


																		<!--/div-->
																		<!--end::NOTIFICACAO CORPO-->
																	
																	<!--/div-->
																	<!--enf::NOTIFICAÇÃO BLOCK MASTER-->

																	<?php 
																	
																		} //foreach

																		echo '</div></div></div>'; //no final do loop fecha o ultimo block que ficou aberto.
