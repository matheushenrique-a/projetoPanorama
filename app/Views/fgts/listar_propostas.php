												...
												<div class="card-title">
													...
													<div class="d-flex align-items-center position-relative my-1 mx-3">
														<div class="mb-3">
															...
															<input type="text" class="form-control" placeholder="Matricula" name="txtMatricula" value="<?php echo $verificador;?>" />
														</div>													
													</div>
												</div>
												<!--begin::Card title-->
														...
														<div class="mb-3">
															...
															<div class="d-flex align-items-center position-relative my-1">
																<select class="form-select form-control-solid" aria-label="" name="statusPropostaFiltro">
																	<option value="" <?php echo $statusPropostaFiltro == '' ? 'selected' : '';?>></option>
																	<option value="PASSO 03 - DADOS PESSOAIS" <?php echo $statusPropostaFiltro == 'PASSO 03 - DADOS PESSOAIS' ? 'selected' : '';?>>PASSO 03 - DADOS PESSOAIS</option>
																	<option value="PASSO 03.1 - DADOS PESSOAIS DOCUMENTOS" <?php echo $statusPropostaFiltro == 'PASSO 03.1 - DADOS PESSOAIS DOCUMENTOS' ? 'selected' : '';?>>PASSO 03.1 - DADOS PESSOAIS DOCUMENTOS</option>
																	<option value="PASSO 07 - GRAVADA" <?php echo $statusPropostaFiltro == 'PASSO 07 - GRAVADA' ? 'selected' : '';?>>PASSO 07 - GRAVADA</option>
																</select>													
															</div>												
													</div>
													<div class="d-flex align-items-center position-relative my-1 mx-3">
