											...
											<div class="card-header border-0 pt-6" style="justify-content: start;">
												...
												<div class="card-title">
													<div class="d-flex align-items-center position-relative my-1 mx-3">
														<div class="mb-3">
															<label for="exampleFormControlInput1" class="form-label text-gray-800 mb-0">Template:</label>
															<input type="text" class="form-control" placeholder="Template" name="content" value="<?php echo $content;?>" />
														</div>													
													</div>
												</div>
												<!--begin::Card title-->
												<div class="card-title">
													<div class="d-flex align-items-center position-relative my-1">
														<div class="mb-3  mx-3">
															<label for="exampleFormControlInput1" class="form-label text-gray-800 mb-0">Categoria:</label>
															<div class="d-flex align-items-center position-relative my-1">
																<select class="form-select form-control-solid" aria-label="" name="display_name">
																	<?php
																		echo '<option value="" ' .  ($display_name == "" ? 'selected' : '') . '> TODOS </option>';
																		foreach ($fases["result"]->getResult() as $row){
																			echo '<option value="' . $row->display_name . '" ' .  ($display_name == $row->display_name ? 'selected' : '') . '>' . $row->display_name . '</option>';
																		}
																	;?>
																</select>
															</div>												
													...
													<div class="d-flex align-items-center position-relative my-1">
														<div class="mb-3  mx-3">
															<label for="exampleFormControlInput1" class="form-label text-gray-800 mb-0">Aprovado:</label>
															<div class="d-flex align-items-center position-relative my-1">
																<select class="form-select form-control-solid" aria-label="" name="whatsAppApproved">
																	<?php
																		echo '<option value="" ' .  ($whatsAppApproved == "" ? 'selected' : '') . '> TODOS </option>';
											...
											<table class="table align-middle table-row-dashed table-hover fs-6 gy-5" id="kt_widget_table_3" data-kt-table-widget-3="all" >
												...
												<thead>
													...
													<tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
														...
														<th class="min-w-25px">Aprovado</th>
														<th class="min-w-25px">Categoria</th>
														<th class="min-w-300px">Mensagem</th>
														<th class="min-w-25px">Excluir</th>
													</tr>
													<!--end::Table row-->
												</thead>
												<!--end::Table head-->
