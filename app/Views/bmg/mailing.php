        ...
        <div class="container mt-2 mb-20">
            <div class="card p-4 w-75 mx-auto">
                ...
                <div class="d-flex flex-column m-3 gap-4">
                    <select class="form-select center" aria-label="Select example">
                    ...
                    <select class="form-select center" aria-label="Select example">
                        ...
                        <option value="1">BMG Med</option>
                        <option value="2">Papcard</option>
                        <option value="3">Vida Familiar</option>
                    </select>
                    ...
                    <div class="d-flex justify-content-between align-items-center mt-5">
                        ...
                        <div>
                            <a href="#" class="btn btn-light-primary">Enviar</a>
                        </div>
                    </div>
                </div>
            </div>
